...
__source__ = "https://github.com/isl-org/Open3D/pull/738#issuecomment-564785941"
...
class LineMesh(object):
    ...
    def create_line_mesh(self):
        ...
        for i in range(line_segments_unit.shape[0]):
            ...
            if self.cylinder_set is None:
                self.cylinder_set = cylinder_segment
            else:
                self.cylinder_set = self.cylinder_set + cylinder_segment
